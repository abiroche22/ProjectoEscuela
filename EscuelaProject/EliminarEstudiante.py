"""Archivo que tiene como funcionalidad eliminar datos tipo estudiante"""

import tkinter as tk
from tkinter import Tk, ttk, messagebox
from Conexion import Conexion

class EliminarEstudiante(tk.Tk):
    def __init__(self):
        super().__init__()
    ...
    def recuperar_datos(self, cedula):
        try:
            if Conexion.CONEXION:
                ...
                query = 'SELECT id, nombres, apellidos, cedula FROM estudiantes WHERE cedula=%s'
                valores = (cedula,)
